...
void GUI_number10(u8 x, u16 y, u16 dat, u16 dcolor, u16 bgcolor); //只显示10位数据
void GUI_number(u8 x, u16 y, u32 dat, u16 dcolor, u16 bgcolor); //显示最大5位的数据  如果非5位状态 其他位不显示 只显示有效值
